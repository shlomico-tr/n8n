...
export class License implements LicenseProvider {
	...
	async init({
		...
		// License manager disabled - all enterprise features are enabled by default
		// No communication with license servers
		this.logger.debug('License manager disabled - all enterprise features enabled');
		return;
	}
	...
	getValue<T extends keyof FeatureReturnType>(feature: T): FeatureReturnType[T] {
		// Return unlimited quota for all features
		if (feature === 'planName') {
